...
export default function Navbar() {
  ...
  // El navbar es transparente SOLO si estamos en home, no scrolleamos y el menú mobile está cerrado
    ...
    >
        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-10">
            ...
            <Button
              ...
              className={`rounded-full px-8 py-3 text-[11px] font-bold tracking-widest uppercase shadow-lg transition-all duration-500 transform hover:scale-105 ${
                isTransparent
                  ? "bg-white !text-neutral-900 hover:bg-neutral-100 shadow-none"
                  : "bg-neutral-900 text-white hover:bg-rose-500 shadow-rose-200"
              }`}
            >
              Reservar Turno
            </Button>
      ...
      >
        ...
        <Button
          ...
          rel="noopener noreferrer"
          onClick={() => setOpen(false)}
          className="rounded-full px-12 py-4 shadow-xl uppercase tracking-widest text-xs font-bold bg-neutral-900 text-white hover:bg-rose-500 transition-colors"
        >
          Reservar Turno
        </Button>
      </div>
